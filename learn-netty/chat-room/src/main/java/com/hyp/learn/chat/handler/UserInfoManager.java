package com.hyp.learn.chat.handler;

import com.hyp.learn.chat.entity.User;
import com.hyp.learn.chat.proto.ChatProto;
import com.hyp.learn.chat.util.BlankUtil;
import com.hyp.learn.chat.util.NettyUtil;
 ...
 * Include in com.hyp.learn.chat.handler
...
public class UserInfoManager {
        ...
        if (!BlankUtil.isBlank(message)) {
            try {
                ...
                for (Channel ch : keySet) {
                    User userInfo = userInfos.get(ch);
    ...
    public static ConcurrentMap<Channel, User> getUserInfos() {
        return userInfos;
    }
